                ...
                <>
                   {/* Animated overlay background */}
                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        <motion.div 
                            className={`rounded-xl shadow-lg p-8 w-full max-w-md relative ${theme === "dark" ? "bg-[#111827]" : "bg-white"}`}
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                ...
                                <select
                                    ...
                                    value={formData.type}
                                    onChange={handleChange}
                                    className={`${theme == "dark" ? "bg-gray-900" : "bg-white"} border border-gray-300 bg-gray-900 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition  required`}>
